...
const dict = {
  tr: {
    ...
    distances_title: 'Ulaşım Bilgisi', distances_km: 'KM', distances_map_button: 'Haritada Göster',
  ...
  en: {
    ...
    distances_title: 'Getting Around', distances_km: 'KM', distances_map_button: 'Show on Map',
